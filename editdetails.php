    ...
    <div class="blueacc_menu">
        <div class="menu">
            <form action="" class='form_flex' method='POST' autocomplete="off">
                <div class="titleacc edit"><img src="../img/icons/icon-person.png" class='icons-img'>
                    <div class="textacc">Modificar detalhes da conta</div>
                </div>
                <div class="flex_join">
                    <input type="text" autocomplete="off" value='<?php echo $_SESSION["Nome"] ?>' maxlength="100"
                        placeholder='NOME' data-aos="fade-up" data-aos-duration="1000" name='nome'
                        class="reg-classe mandatory icnrr" require>
                    <input type="email" autocomplete="off" value='<?php echo $_SESSION["Email"] ?>' maxlength="50"
                        placeholder='EMAIL' name='email' data-aos="fade-up" data-aos-duration="1000"
                        pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" title='Email incorreto'
                        class="reg-classe mandatory incrr" require>
                </div>
                <div class="flex_join">
                    <input type="text" autocomplete="off" value='<?php echo $_SESSION["Morada"] ?>' placeholder='MORADA'
                        data-aos="fade-up" data-aos-duration="1000" name='morada' class="reg-classe">
                    <input type="text" autocomplete="off" value='<?php echo $_SESSION["Codpostal"] ?>'
                        placeholder='CÓDIGO POSTAL' data-aos="fade-up" data-aos-duration="1000" name='cod'
                        class="reg-classe">
                </div>
                <div class="flex_join">
                    <input type="tel" autocomplete="off" value='<?php echo $_SESSION["Telefone_pess"] ?>'
                        placeholder='TELEFONE' maxlength="9" data-aos="fade-up" data-aos-duration="1000" name='tel'
                        pattern="[0-9]+" class="reg-classe mandatory incrr">
                    <input type="text" autocomplete="off" value='<?php echo $_SESSION["NIF"] ?>' placeholder='NIF'
                        pattern="[0-9]+" data-aos="fade-up" data-aos-duration="1000" name='nif' maxlength="9"
                        class="reg-classe">
                </div>
                <div class="flex_join">
                    <input type="text" autocomplete="off" value='<?php echo $_SESSION["Nomeempresa"] ?>'
                        placeholder='NOME DA EMPRESA' minlength="2" data-aos="fade-up" data-aos-duration="1000"
                        name='empresa' class="reg-classe mandatory incrr">
