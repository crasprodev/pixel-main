<div class="folha_de_obra">
    ...
    cursor: pointer;" readonly=""></div>
            ...
            <div class="flex_userdata_group">
                ...
                <div class="userdata_group"> <label for="">NIF</label> <input type="text" name="Contacto" readonly=""
                        style="text-align: center;"></div>
            </div>
            <div class="flex_userdata_group">
                <div class="userdata_group"> <label for="">Contactos</label> <input type="text" name="Email" readonly=""
                        style="text-align: center;">
                </div>
