...
<body>
        ...
        <div class="menu login">
            ...
            <form action="" class='form_flex login' method='POST' autocomplete="off">
                <div class="titleacc_login"><img src="../img/icons/icon-person.png" class='icons-img'>
                    <div class="textacc">Entrar na conta</div>
                </div>
                <div class="flex_join_login">
                    <input type="text" maxlength="100" placeholder='*EMAIL' data-aos="fade-up" data-aos-duration="1000"
                        name='nome' class="reg-classe email-login" required>
                    <input type="password" placeholder='*PASSWORD' data-aos="fade-up" data-aos-duration="1000"
                        name='password' class="reg-classe password-login" required>
                </div>
                <div class="btn-enviar btn-envem login">></div>
                <div class="flex-cooke"> Quer se lembrar da sessão? <input type="checkbox" name="sessao" id="paiva">
                </div>
                <a href="resetpassword.php" class="frg_pass">Esqueci-me da palavra-passe</a>
                <input type="submit" class='submit' style='display:none'> <a href="signin.php" class='init_ses'>Não tem
                    conta?</a>
            </form>
    ...
    <script>
    $(".form_flex.login input").on("keypress", function(event) {
